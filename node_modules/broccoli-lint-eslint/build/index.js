...
EslintValidationFilter.prototype.cacheKeyProcessString = function cacheKeyProcessString(content, relativePath) {
  ...
  return md5Hex([content, relativePath, stringify(this.internalOptions, { replacer: functionStringifier }), stringify(this.cli.getConfigForFile(path.join(this.eslintrc, relativePath)))]);
};
 ...
 */
EslintValidationFilter.prototype.postProcess = function postProcess(_ref /* , relativePath */) {
